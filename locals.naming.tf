locals {
  ...
  data_factory_name   = var.custom_data_factory_name != null && var.custom_data_factory_name != "" ? var.custom_data_factory_name : lower(data.popsrox_resource_name.data_factory_name.result)
}
